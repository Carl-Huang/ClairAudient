...
- (IBAction)startCutting:(id)sender {
    ...
    [MusicCutter cropMusic:edittingMusicFile exportFileName:@"newSong.mov" withStartTime:self.startTime.text.floatValue*60 endTime:self.endTime.text.floatValue*60 withCompletedBlock:^(AVAssetExportSessionStatus status, NSError *error) {
