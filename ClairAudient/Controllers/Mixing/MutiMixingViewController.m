...
- (void)viewDidLoad
{
    ...
    [plotViewUp setupAudioPlotViewWitnNimber:2 type:OutputTypeDefautl withCompletedBlock:^(BOOL isFinish) {
//        if (isFinish) {
//            plotViewDown = [[AudioPlotView alloc]initWithFrame:CGRectMake(0, 80+plotViewUp.frame.size.height, 320, 140)];
//            [plotViewDown setupAudioPlotViewWitnNimber:1 type:OutputTypeHelper withCompletedBlock:^(BOOL isFinish) {
//                ;
//            }];
//            
