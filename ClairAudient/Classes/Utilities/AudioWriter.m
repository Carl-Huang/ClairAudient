...
//        CheckError(ExtAudioFileCreateWithURL(audioFileRef, kAudioFileM4AType, &outputFileDesc, NULL, kAudioFileFlags_EraseFile, &_outputFile), "Creating file");
        ...
        CheckError(ExtAudioFileCreateWithURL(audioFileRef, kAudioFileCAFType, &_outputFormat, NULL, kAudioFileFlags_EraseFile, &_outputFile), "Creating file");
        CheckError( ExtAudioFileSetProperty(_outputFile, kExtAudioFileProperty_ClientDataFormat, sizeof(AudioStreamBasicDescription), &_outputFormat),"Apply the format to our file");
